 ...
 */
public class RecyclerViewAdapter_Political extends RecyclerView.Adapter<RecyclerViewAdapter_Political.MyViewHolder> {
    ...
    public RecyclerViewAdapter_Political(Context context, List<ImageUploadInfo> TempList) throws IOException {
    ...
    @Override
    public RecyclerViewAdapter_Political.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent, false);
        RecyclerViewAdapter_Political.MyViewHolder viewHolder = new RecyclerViewAdapter_Political.MyViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Political.MyViewHolder holder, final int position) {
                ...
                mFirebaseInstance.getReference("All_Image_Uploads_Database").child(name).
                        addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                mFirebaseInstance.getReference("All_Image_Uploads_Database").child(name).child(key[(int) (dataSnapshot.getChildrenCount() - position -1)]).removeValue();
