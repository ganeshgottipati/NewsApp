 ...
 */
public class RecyclerViewAdapter_Movies extends RecyclerView.Adapter<RecyclerViewAdapter_Movies.MyViewHolder> {
    ...
    public RecyclerViewAdapter_Movies(Context context, List<ImageUploadInfo> TempList) throws IOException {
    ...
    @Override
    public RecyclerViewAdapter_Movies.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent, false);
        RecyclerViewAdapter_Movies.MyViewHolder viewHolder = new RecyclerViewAdapter_Movies.MyViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Movies.MyViewHolder holder, final int position) {
