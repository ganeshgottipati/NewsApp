...
public class Education extends Fragment{
    private String Database_Path = "All_Image_Uploads_Database/Education";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference commandsRef = databaseReference.child("All_Image_Uploads_Database").child("Education");
        ...
        commandsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                try {
                    ...
                    editor.commit();
                    adapter = new RecyclerViewAdapter_Education(getActivity(),list);
                } catch (IOException e) {
                    e.printStackTrace();
                }
