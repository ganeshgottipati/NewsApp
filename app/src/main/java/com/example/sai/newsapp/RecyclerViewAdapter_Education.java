 ...
 */
public class RecyclerViewAdapter_Education extends RecyclerView.Adapter<RecyclerViewAdapter_Education.MyViewHolder> {
    ...
    public RecyclerViewAdapter_Education(Context context, List<ImageUploadInfo> TempList) throws IOException {
    ...
    @Override
    public RecyclerViewAdapter_Education.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent, false);
        RecyclerViewAdapter_Education.MyViewHolder viewHolder = new RecyclerViewAdapter_Education.MyViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Education.MyViewHolder holder, final int position) {
