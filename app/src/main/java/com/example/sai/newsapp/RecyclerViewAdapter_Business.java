 ...
 */
public class RecyclerViewAdapter_Business extends RecyclerView.Adapter<RecyclerViewAdapter_Business.MyViewHolder> {
    ...
    public RecyclerViewAdapter_Business(Context context, List<ImageUploadInfo> TempList) throws IOException {
    ...
    @Override
    public RecyclerViewAdapter_Business.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent, false);
        RecyclerViewAdapter_Business.MyViewHolder viewHolder = new RecyclerViewAdapter_Business.MyViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Business.MyViewHolder holder, final int position) {
